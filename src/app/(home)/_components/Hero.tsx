  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-0 scale-105 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,var(--background)_100%)] opacity-80 z-[2]" />
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-24 md:pt-36 md:pb-28 flex flex-col items-center text-center">
        ...
        >
          <div className="inline-flex items-center gap-3 px-4 py-2 border border-primary/30 rounded-full bg-primary/10 backdrop-blur-md mb-4 md:mb-6">
            <div className="w-1.5 h-1.5 rounded-full bg-brand-light animate-pulse flex-shrink-0" />
            <span className="text-[10px] text-brand-light font-bold tracking-[0.25em] uppercase">
              The Collective Rise
            </span>
          </div>
        ...
        >
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-foreground/70">
