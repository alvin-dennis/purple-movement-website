        ...
        <div className="flex flex-col lg:flex-row gap-12 md:gap-16 lg:gap-24 items-start">
          <div className="w-full lg:w-1/3 flex flex-col gap-8 md:gap-12 lg:sticky lg:top-40">
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-7xl text-white leading-none">
                THE<br />
                <span className="bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent border-b-2 border-purple-600 py-2 md:py-4 block">PHILOSOPHY</span>
              </h2>
            </div>
          ...
          <div className="w-full lg:w-2/3 flex flex-col gap-16 md:gap-24">
            ...
            <motion.div
              ...
              className="relative"
            >
              <span className="text-[20vw] absolute -top-10 md:-top-20 -left-4 md:-left-10 font-black text-white/[0.03] leading-none pointer-events-none select-none">&ldquo;PURPLE&rdquo;</span>
              <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-black text-white leading-[1.1] relative z-10">
                ...
                <span className="bg-gradient-to-r from-purple-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent">It is a bridge between worlds.</span>
              </h3>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 relative">
              ...
              >
                ...
                <h4 className="text-3xl md:text-4xl font-black text-white mb-4 md:mb-6 uppercase">RED</h4>
              ...
              >
                ...
                <h4 className="text-3xl md:text-4xl font-black text-white mb-4 md:mb-6 uppercase">BLUE</h4>
                <p className="text-white/60 text-base md:text-lg lg:text-xl leading-relaxed">
            ...
            <div className="w-full glass-panel p-8 sm:p-12 md:p-16 lg:p-20 relative overflow-hidden group">
              ...
              <div className="flex flex-col gap-8 md:gap-12 relative z-10">
                <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase leading-none">
                  WE AIM TO<br />
                  <span className="text-purple-500">BRIDGE THAT GAP.</span>
                </h3>
                  ...
                  >
                    <div className="pt-12 md:pt-20 grid grid-cols-1 sm:grid-cols-3 gap-8 md:gap-12">
                      {[
                        ...
                        <div key={text} className="flex flex-col gap-4">
                          ...
                          <p className="text-white font-bold text-base md:text-lg uppercase tracking-widest">{text}</p>
                        </div>
                      ))}
                    </div>
                    <div className="mt-12 md:mt-20 p-8 md:p-12 bg-white/5 border border-white/5 rounded-[2rem] md:rounded-[3rem]">
                      <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-purple-500 uppercase leading-[0.9]">
                        WE&apos;RE HERE TO MAKE THAT <span className="text-white">PLACE REAL.</span>
                      </p>
                    </div>
                  </motion.div>
                )}
