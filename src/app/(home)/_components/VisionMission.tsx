    ...
    >
      <div className="max-w-[1400px] mx-auto w-full flex flex-col gap-16 sm:gap-24 md:gap-32 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-12 items-start relative z-10">
          ...
          >
            <div className="flex flex-col gap-3 md:gap-4">
              ...
              <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-7xl text-white leading-[0.9]">
                OUR<br />
                <span className="bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent">VISION</span>
              </h2>
            </div>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-white/50 border-l border-white/10 pl-6 md:pl-10">
          ...
          >
            <div className="flex flex-col gap-3 md:gap-4 lg:items-end">
              ...
              <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-7xl text-white leading-[0.9]">
                OUR<br />
                <span className="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">MISSION</span>
              </h2>
            </div>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-white/50 lg:border-r lg:border-l-0 border-l border-white/10 lg:pr-10 lg:pl-0 pl-6 lg:text-right">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-5xl mx-auto text-center border-t border-b border-white/5 py-12 px-4"
        >
          <h3 className="text-5xl sm:text-6xl md:text-7xl lg:text-7xl font-black text-white leading-tight uppercase opacity-80">
            Together, we create an open cycle of shared learning, mutual
            support, and lifelong empowerment because{" "}
            <br className="hidden md:block" />
            <span className="text-purple-500 tracking-[0.15em] md:tracking-[0.2em] font-normal text-lg md:text-2xl mt-6 md:mt-8 block">
